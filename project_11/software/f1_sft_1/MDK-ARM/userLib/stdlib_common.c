...
static const commonGpioMap_t gpioMap[GPIO_ID_COUNT] = {
    [GPIO_ID_USER_IO_1] = { USER_IO_1_GPIO_Port, USER_IO_1_Pin, COMMON_GPIO_DIR_INPUT,  GPIO_PIN_RESET },
    [GPIO_ID_USER_IO_2] = { USER_IO_2_GPIO_Port, USER_IO_2_Pin, COMMON_GPIO_DIR_INPUT,  GPIO_PIN_RESET },
