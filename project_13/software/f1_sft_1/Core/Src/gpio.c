...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, USER_IO_7_Pin|USER_IO_8_Pin|USER_IO_2_Pin|I2C_SCL_2_Pin
                          |I2C_SDA_2_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : USER_IO_7_Pin USER_IO_8_Pin USER_IO_2_Pin */
  GPIO_InitStruct.Pin = USER_IO_7_Pin|USER_IO_8_Pin|USER_IO_2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pin : I2C_SCL_2_Pin */
  GPIO_InitStruct.Pin = I2C_SCL_2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(I2C_SCL_2_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : I2C_SDA_2_Pin */
  GPIO_InitStruct.Pin = I2C_SDA_2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_OD;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(I2C_SDA_2_GPIO_Port, &GPIO_InitStruct);
