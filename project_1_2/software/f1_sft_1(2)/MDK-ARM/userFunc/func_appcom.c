...
void FUNC_APPCOM_TxUpdate(void){
  ...
  appcomInfo.appCmdFrameArr[0].payload.var_4b_2 = remoteInfo.null;
  appcomInfo.appCmdFrameArr[0].payload.var_1b_1 = remoteInfo.null;
  appcomInfo.appCmdFrameArr[0].payload.var_1b_2 = remoteInfo.null;

  /* ---- CMD 0x0A ---- */
  appcomInfo.appCmdFrameArr[1].payload.var_4b_1 = remoteInfo.var[0];
  appcomInfo.appCmdFrameArr[1].payload.var_4b_2 = remoteInfo.var[1];
  appcomInfo.appCmdFrameArr[1].payload.var_1b_1 = remoteInfo.var[2];
  appcomInfo.appCmdFrameArr[1].payload.var_1b_2 = remoteInfo.var[3];
...
void FUNC_APPCOM_RxUpdate(void){
  ...
  remoteInfo.key1 = appcomInfo.appCmdFrameArr[4].payload.var_1b_1;
  remoteInfo.key2 = appcomInfo.appCmdFrameArr[4].payload.var_1b_2;
