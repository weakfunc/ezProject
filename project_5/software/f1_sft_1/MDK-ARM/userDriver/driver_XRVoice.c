...
static const xrVoiceCmdEntry_t xrVoiceCmdTable[XRVOICE_CMD_TABLE_SIZE] = {
  ...
  {{0xAAU, 0x55U, 0x01U, 0x00U, 0xFBU}},  /* 语义1 ：欢迎使用小R科技语音助手 */
  {{0xAAU, 0x55U, 0x01U, 0x01U, 0xFBU}},  /* 语义2 ：我去消息框 */
  {{0xAAU, 0x55U, 0x01U, 0x02U, 0xFBU}},  /* 语义3 ：在的（唤醒词：小二同学） */
  {{0xAAU, 0x55U, 0x01U, 0x03U, 0xFBU}},  /* 语义4 ：增大音量 */
  {{0xAAU, 0x55U, 0x01U, 0x04U, 0xFBU}},  /* 语义5 ：减小音量 */
  {{0xAAU, 0x55U, 0x01U, 0x05U, 0xFBU}},  /* 语义6 ：最大音量 */
  {{0xAAU, 0x55U, 0x01U, 0x06U, 0xFBU}},  /* 语义7 ：中等音量 */
  {{0xAAU, 0x55U, 0x01U, 0x07U, 0xFBU}},  /* 语义8 ：最小音量 */
  {{0xAAU, 0x55U, 0x01U, 0x08U, 0xFBU}},  /* 语义9 ：开启播报 */
  {{0xAAU, 0x55U, 0x01U, 0x09U, 0xFBU}},  /* 语义10：关闭播报 */
  /* ---- 语义 11~53：FF 00 XX 00 FF ---- */
  ...
  {{0xFFU, 0x00U, 0x05U, 0x00U, 0xFFU}},  /* 语义x：自定义添加 */
};
