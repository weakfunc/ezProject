...
- 新建driver_XRVoice模块，该模块为语音模块，使用I2C通信，默认使用I2C_BUS_1
- 根目录下Src文件夹和Inc文件夹内是该模块的官方例程，需要把它移植到driver_XRVoice模块中
- 注意：只移植通信协议部分，例程中与协议无关的部分如调试输出等内容不要移植
- 移植到driver_XRVoice模块中的API均需写出注释
