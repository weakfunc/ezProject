...
static const commonGpioMap_t gpioMap[GPIO_ID_COUNT] = {
    ...
    [GPIO_ID_USER_IO_5] = { USER_IO_5_GPIO_Port, USER_IO_5_Pin, COMMON_GPIO_DIR_INPUT,  GPIO_PIN_SET },
    [GPIO_ID_USER_IO_6] = { USER_IO_6_GPIO_Port, USER_IO_6_Pin, COMMON_GPIO_DIR_INPUT,  GPIO_PIN_SET },
    [GPIO_ID_USER_IO_7] = { USER_IO_7_GPIO_Port, USER_IO_7_Pin, COMMON_GPIO_DIR_INPUT,  GPIO_PIN_SET },
    [GPIO_ID_USER_IO_8] = { USER_IO_8_GPIO_Port, USER_IO_8_Pin, COMMON_GPIO_DIR_INPUT,  GPIO_PIN_SET },
